...
if "ancgenes" in config:
    ...
    ANCGENES = f'{config["jobname"]}/TGD_ancGenes.tsv' #file generated by the pipeline
...
rule homogenize_references_ab:
    ...
    input:
        ...
        ancGenes = ANCGENES
    output: expand(f'{config["jobname"]}/{{ref_species}}_colors_homogenized.txt',
                     ref_species=REF_SPECIES)
...
rule consensus_color_ancGene:
    ...
    """
    input: ref_colors = expand(f'{config["jobname"]}/{{ref_species}}_colors_homogenized.txt',
                                 ref_species=REF_SPECIES),
           genes = expand(GENES, ref_species=REF_SPECIES),
           ancGenes = ANCGENES
...
rule draw_paralogy_map:
    ...
    output: plot = report(f'{config["jobname"]}/{{dup_species}}_ParalogyMap.svg', category="Comparative atlas"),
